<?php include_once "includes/header.php";
  ...
  if (!empty($_POST)) {
    $alert = "";
    if (empty($_POST['proveedor']) || empty($_POST['descripcion']) || empty($_POST['precio']) || $_POST['precio'] <  0 || empty($_POST['cantidad'] || $_POST['cantidad'] <  0) || empty($_FILES['imagen'])){
      ...
      $query_insert = mysqli_query($conexion, "INSERT INTO `producto`( `descripcion`, `proveedor`, `precio`, `existencia`, `imagen`, `usuario_id`)values ('$descripcion', '$proveedor', '$precio', '$cantidad', '$img', '$usuario_id')");
      if ($query_insert) {
